...
-- 시퀀스 넘버확인 번호 ?兮?
SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'TASK_SEQ_NO';
SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'SCORE_SEQ_NO';
SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'SECTION_SEQ_NO';
SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'SECTION_TASKS_SEQ_NO';

SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'ACCOUNT_SEQ_NO';
SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'ATTENDANCE_SEQ_NO';
SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'AUTH_CLASS_SEQ_NO';
SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'AUTH_STUDENT_SEQ_NO';
SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'CLASS_SEQ_NO';
SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'CLASS_MEMBERS_SEQ_NO';
SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'SCHOOL_SEQ_NO';
SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'SEASON_SEQ_NO';
SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'STUDENT_SEQ_NO';

alter sequence SCHOOL_SEQ_NO nocache;
ALTER SEQUENCE SCHOOL_SEQ_NO INCREMENT BY +1;
select SCHOOL_SEQ_NO.nextval from dual;

alter sequence SEASON_SEQ_NO nocache;
ALTER SEQUENCE SEASON_SEQ_NO INCREMENT BY +1;
select SEASON_SEQ_NO.nextval from dual;

alter sequence STUDENT_SEQ_NO nocache;
ALTER SEQUENCE STUDENT_SEQ_NO INCREMENT BY +1;
select STUDENT_SEQ_NO.nextval from dual;

alter sequence CLASS_MEMBERS_SEQ_NO nocache;
ALTER SEQUENCE CLASS_MEMBERS_SEQ_NO INCREMENT BY +1;
select CLASS_MEMBERS_SEQ_NO.nextval from dual;

alter sequence CLASS_SEQ_NO nocache;
ALTER SEQUENCE CLASS_SEQ_NO INCREMENT BY +1;
select CLASS_SEQ_NO.nextval from dual;

alter sequence AUTH_STUDENT_SEQ_NO nocache;
ALTER SEQUENCE AUTH_STUDENT_SEQ_NO INCREMENT BY +1;
select AUTH_STUDENT_SEQ_NO.nextval from dual;

alter sequence AUTH_CLASS_SEQ_NO nocache;
ALTER SEQUENCE AUTH_CLASS_SEQ_NO INCREMENT BY +1;
select AUTH_CLASS_SEQ_NO.nextval from dual;

alter sequence ATTENDANCE_SEQ_NO nocache;
ALTER SEQUENCE ATTENDANCE_SEQ_NO INCREMENT BY +1;
select ATTENDANCE_SEQ_NO.nextval from dual;

alter sequence ACCOUNT_SEQ_NO nocache;
ALTER SEQUENCE ACCOUNT_SEQ_NO INCREMENT BY +1;
select ACCOUNT_SEQ_NO.nextval from dual;

alter sequence SCORE_SEQ_NO nocache;
  ALTER SEQUENCE SCORE_SEQ_NO INCREMENT BY +1;
   select score_seq_no.nextval from dual;

alter sequence TASK_SEQ_NO nocache;
ALTER SEQUENCE TASK_SEQ_NO INCREMENT BY +1;
select TASK_SEQ_NO.nextval from dual;

alter sequence SECTION_TASKS_SEQ_NO nocache;
ALTER SEQUENCE SECTION_TASKS_SEQ_NO INCREMENT BY +1;
select SECTION_TASKS_SEQ_NO.nextval from dual;

alter sequence SECTION_SEQ_NO nocache;
ALTER SEQUENCE SECTION_SEQ_NO INCREMENT BY +1;
select SECTION_SEQ_NO.nextval from dual;
